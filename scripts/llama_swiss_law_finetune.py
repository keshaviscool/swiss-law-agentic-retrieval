...
# ── Modal setup ───────────────────────────────────────────────────────────────
app = modal.App("llama-swiss-law-finetune")

# Volume to persist the trained adapter
volume = modal.Volume.from_name("llama-law-adapter-rank32-epoch3", create_if_missing=True)
...
def finetune(samples: list[dict]):
    ...
    OUTPUT_DIR = "/output/llama_swiss_law_adapter"
